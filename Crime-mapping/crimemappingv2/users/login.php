<?php
    ...
    if (isset($_SESSION['Username']) && isset($_SESSION['UserRole'])) {
        $sessionRole = strtolower((string)$_SESSION['UserRole']);
        ...
        if ($sessionRole === 'barangay' && !empty($_SESSION['BarangayID'])) {
        ...
        <div class="card login-card shadow-lg">
            <div class="card-body">
                ...
                <form action="login.php" method="post">
                    ...
                    <div class="d-grid">
                        <a href="../map.php" class="btn btn-outline-secondary btn-lg">Back to Map</a>
                    </div>
                </form>
            </div>
        </div>
